...
namespace PetRego.Tests.Controllers
{
    ...
    public class TestOwnersController
    {
        ...
        public void GetOwner_ShouldReturnOwnerWithSameID()
        {
            ...
            var result = controller.GetOwner(3) as OkNegotiatedContentResult<OwnerDTO>;

            Assert.IsNotNull(result);
            Assert.AreEqual(3, result.Content.OwnerId);
        }
        ...
        public void DeleteOwner_ShouldReturnOK()
        {
            ...
            var controller = new OwnersController(new OwnerService(context));
            var result = controller.DeleteOwner(3) as OkNegotiatedContentResult<Owner>;
        ...
        Owner GetDemoOwner()
        {
            ...
            pets.Add(new Pet() { PetId = 3, PetName = "Demo Pet 1", PetType = "Demo Type 1", OwnerId = 3 });
            pets.Add(new Pet() { PetId = 4, PetName = "Demo Pet 2", PetType = "Demo Type 2", OwnerId = 3 });
            return new Owner() { OwnerId = 3, Ownername = "Demo name", Pets = pets };
        }
        ...
        TestPetRegoContext getPetRegoContext()
        {
            var context = new TestPetRegoContext();
            List<Pet> pets = new List<Pet>();
            pets.Add(new Pet() { PetId = 3, PetName = "Demo Pet 1", PetType = "Demo Type 1", OwnerId = 1 });
            pets.Add(new Pet() { PetId = 4, PetName = "Demo Pet 2", PetType = "Demo Type 2", OwnerId = 1 });
            ...
            pets.Add(new Pet() { PetId = 3, PetName = "Demo Pet 5", PetType = "Demo Type 5", OwnerId = 3 });
            pets.Add(new Pet() { PetId = 4, PetName = "Demo Pet 6", PetType = "Demo Type 6", OwnerId = 3 });
